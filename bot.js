...
// NOTE: Disabled due to deployment issues - uncomment to enable locally
// ============================================
...
async function startUserbot() {
  ...
  console.log('⚠️ Userbot disabled - run locally to enable');
  
  // TODO: Re-enable after fixing npm install issues
